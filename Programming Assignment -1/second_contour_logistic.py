####### Gradient Function for Ridge regularized Logistic  Function( with given intial values and step sizes)
import numpy as np
...
for kx in range(3):
    ...
    ax.set_xlabel(r'$x$')
    ax.set_ylabel(r'$y$')
    titlex='Contour plot for logistic functions with step size : '+str(step_size)
    ax.set_title(titlex)
plt.show()
